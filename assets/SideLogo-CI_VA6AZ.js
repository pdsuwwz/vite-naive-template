...
`,[m("children-placeholder",`
 ...
 cursor: not-allowed;
 opacity: .5;
 `)])]),mt=Object.assign(Object.assign({},he.props),{size:{type:String,default:"medium"},value:{type:[String,Number,Boolean],default:void 0},loading:Boolean,defaultValue:{type:[String,Number,Boolean],default:!1},disabled:{type:Boolean,default:void 0},round:{type:Boolean,default:!0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],checkedValue:{type:[String,Number,Boolean],default:!0},uncheckedValue:{type:[String,Number,Boolean],default:!1},railStyle:Function,rubberBand:{type:Boolean,default:!0},onChange:[Function,Array]});let se;const wt=T({name:"Switch",props:mt,slots:Object,setup(e){se===void 0&&(typeof CSS<"u"?typeof CSS.supports<"u"?se=CSS.supports("width","max(1px)"):se=!1:se=!0);const{mergedClsPrefixRef:n,inlineThemeDisabled:t}=Me(e),o=he("Switch","-switch",yt,un,e,n),r=fn(e),{mergedSizeRef:a,mergedDisabledRef:i}=r,s=G(e.defaultValue),l=q(e,"value"),d=Ve(l,s),p=P(()=>d.value===e.checkedValue),f=G(!1),b=G(!1),C=P(()=>{const{railStyle:v}=e;if(v)return v({focused:b.value,checked:p.value})});function w(v){const{"onUpdate:value":$,onChange:S,onUpdateValue:O}=e,{nTriggerFormInput:g,nTriggerFormChange:R}=r;$&&re($,v),O&&re(O,v),S&&re(S,v),s.value=v,g(),R()}function z(){const{nTriggerFormFocus:v}=r;v()}function I(){const{nTriggerFormBlur:v}=r;v()}function B(){e.loading||i.value||(d.value!==e.checkedValue?w(e.checkedValue):w(e.uncheckedValue))}function U(){b.value=!0,z()}function E(){b.value=!1,I(),f.value=!1}function u(v){e.loading||i.value||v.key===" "&&(d.value!==e.checkedValue?w(e.checkedValue):w(e.uncheckedValue),f.value=!1)}function h(v){e.loading||i.value||v.key===" "&&(v.preventDefault(),f.value=!0)}const K=P(()=>{const{value:v}=a,{self:{opacityDisabled:$,railColor:S,railColorActive:O,buttonBoxShadow:g,buttonColor:R,boxShadowFocus:k,loadingColor:x,textColor:F,iconColor:y,[D("buttonHeight",v)]:_,[D("buttonWidth",v)]:H,[D("buttonWidthPressed",v)]:Z,[D("railHeight",v)]:M,[D("railWidth",v)]:V,[D("railBorderRadius",v)]:be,[D("buttonBorderRadius",v)]:ye},common:{cubicBezierEaseInOut:me}}=o.value;let ae,N,we;return se?(ae=`calc((${M} - ${_}) / 2)`,N=`max(${M}, ${_})`,we=`max(${V}, calc(${V} + ${_} - ${M}))`):(ae=ke((X(M)-X(_))/2),N=ke(Math.max(X(M),X(_))),we=X(M)>X(_)?V:ke(X(V)+X(_)-X(M))),{"--n-bezier":me,"--n-button-border-radius":ye,"--n-button-box-shadow":g,"--n-button-color":R,"--n-button-width":H,"--n-button-width-pressed":Z,"--n-button-height":_,"--n-height":N,"--n-offset":ae,"--n-opacity-disabled":$,"--n-rail-border-radius":be,"--n-rail-color":S,"--n-rail-color-active":O,"--n-rail-height":M,"--n-rail-width":V,"--n-width":we,"--n-box-shadow-focus":k,"--n-loading-color":x,"--n-text-color":F,"--n-icon-color":y}}),A=t?je("switch",P(()=>a.value[0]),K,e):void 0;return{handleClick:B,handleBlur:E,handleFocus:U,handleKeyup:u,handleKeydown:h,mergedRailStyle:C,pressed:f,mergedClsPrefix:n,mergedValue:d,checked:p,mergedDisabled:i,cssVars:t?void 0:K,themeClass:A?.themeClass,onRender:A?.onRender}},render(){const{mergedClsPrefix:e,mergedDisabled:n,checked:t,mergedRailStyle:o,onRender:r,$slots:a}=this;r?.();const{checked:i,unchecked:s,icon:l,"checked-icon":d,"unchecked-icon":p}=a,f=!(xe(l)&&xe(d)&&xe(p));return c("div",{role:"switch","aria-checked":t,class:[`${e}-switch`,this.themeClass,f&&`${e}-switch--icon`,t&&`${e}-switch--active`,n&&`${e}-switch--disabled`,this.round&&`${e}-switch--round`,this.loading&&`${e}-switch--loading`,this.pressed&&`${e}-switch--pressed`,this.rubberBand&&`${e}-switch--rubber-band`],tabindex:this.mergedDisabled?void 0:0,style:this.cssVars,onClick:this.handleClick,onFocus:this.handleFocus,onBlur:this.handleBlur,onKeyup:this.handleKeyup,onKeydown:this.handleKeydown},c("div",{class:`${e}-switch__rail`,"aria-hidden":"true",style:o},te(i,b=>te(s,C=>b||C?c("div",{"aria-hidden":!0,class:`${e}-switch__children-placeholder`},c("div",{class:`${e}-switch__rail-placeholder`},c("div",{class:`${e}-switch__button-placeholder`}),b),c("div",{class:`${e}-switch__rail-placeholder`},c("div",{class:`${e}-switch__button-placeholder`}),C)):null)),c("div",{class:`${e}-switch__button`},te(l,b=>te(d,C=>te(p,w=>c(dn,null,{default:()=>this.loading?c(cn,{key:"loading",clsPrefix:e,strokeWidth:20}):this.checked&&(C||b)?c("div",{class:`${e}-switch__button-icon`,key:C?"checked-icon":"icon"},C||b):!this.checked&&(w||b)?c("div",{class:`${e}-switch__button-icon`,key:w?"unchecked-icon":"icon"},w||b):null})))),te(i,b=>b&&c("div",{key:"checked",class:`${e}-switch__checked`},b)),te(s,b=>b&&c("div",{key:"unchecked",class:`${e}-switch__unchecked`},b)))))}}),xt={class:"navigation-change-theme"},kt=T({__name:"ChangeTheme",setup(e){const n=hn(),{isDark:t}=pn(),o=G(n.theme),r=({focused:i,checked:s})=>{const l={};return s?(l.background="#313136",l.boxShadow="0 0 0 1px rgb(100 100 100)"):(l.background="#f6f5f7",l.boxShadow="0 0 0 1px rgb(60 60 67 / 40%)"),l},a=i=>{n.setTheme(i)};return(i,s)=>{const l=pe,d=wt;return ne(),ie("div",xt,[J(d,{value:de(o),"onUpdate:value":[s[0]||(s[0]=p=>gn(o)?o.value=p:null),a],"checked-value":"dark","unchecked-value":"light","rail-style":r,style:vn({"--n-icon-color":de(t)?"#fff":"#000","--n-button-color":de(t)?"#000":"#fff","--n-button-box-shadow":"none"})},{"checked-icon":Q(()=>[J(l,null,{default:Q(()=>s[1]||(s[1]=[W("div",{class:"i-tdesign:mode-dark"},null,-1)])),_:1,__:[1]})]),"unchecked-icon":Q(()=>[J(l,null,{default:Q(()=>s[2]||(s[2]=[W("div",{class:"i-solar:sun-2-outline"},null,-1)])),_:1,__:[2]})]),_:1},8,["value","style"])])}}}),_t=T({name:"NavigationAvatar",setup(){bn(),yn();const e=t=>()=>c(pe,null,{default:()=>c(t)});return{commandList:P(()=>[{label:"退出登录",key:"退出按钮",icon:e(c("div",{class:"text-16px i-fluent:sign-out-20-regular"})),props:{onClick:()=>{mn.remove("token"),window.location.reload()}}}])}}}),St={class:"navigation-avatar"};function Nt(e,n,t,o,r,a){const i=pe,s=bt;return ne(),Ge(s,{trigger:"hover",options:e.commandList},{default:Q(()=>[W("div",St,[J(i,{size:24},{default:Q(()=>n[0]||(n[0]=[W("div",{class:"i-carbon:user-avatar"},null,-1)])),_:1,__:[0]})])]),_:1},8,["options"])}const Rt=ve(_t,[["render",Nt]]),Qe=Symbol(),Mt=()=>{const e=G(!0),{changeNotifyPlacement:n}=wn(),t=()=>{e.value=!1,xn(()=>{n("bottom-right"),window.$ModalNotification.destroyAll(),window.$ModalNotification.success({title:"页面刷新成功",duration:800,closable:!0}),e.value=!0})};return oe(Qe,t),{isRouterAlive:e,reloadRouterView:t}},Ct=()=>({reloadRouterView:ee(Qe)}),Pt=T({__name:"Refresh",setup(e){const{reloadRouterView:n}=Ct();return(t,o)=>{const r=Ln;return ne(),Ge(r,null,{trigger:Q(()=>[W("div",{class:"h-full text-1.5em i-material-symbols:refresh",flex:"~ items-center","cursor-pointer":"",onClick:o[0]||(o[0]=a=>de(n)())})]),default:Q(()=>[o[1]||(o[1]=kn(" 强制刷新路由 "))]),_:1,__:[1]})}}}),Kt=T({name:"NavigationSideAction",emits:["click"],setup(){const{proxy:e}=Bn();function n(){e.$emit("click")}return{title:P(()=>"NaiveUI Template 项目"),handleClick:n}}}),$t={class:"side-action-container"},At={class:"action-list"};function It(e,n,t,o,r,a){return ne(),ie("div",$t,[W("ul",At,[(ne(),ie($e,null,_n(3,i=>W("li",{key:i,class:"action-item bg-#eee dark:bg-#555"}," Action "+Ue(i),1)),64))])])}const Lt=ve(Kt,[["render",It],["__scopeId","data-v-e1c7de5e"]]),Bt=T({__name:"NavBar",props:{auth:{type:Boolean,default:!0},fixed:{type:Boolean,default:!0}},setup(e){return(n,t)=>{const o=Lt,r=Pt,a=Rt,i=kt;return ne(),ie("header",{class:Re(["navigation-navbar-header-container",{"fixed-header":e.fixed,"navbar-shadow dark:dark-navbar-shadow":e.auth,"login-navbar-shadow dark:shadow-none":!e.auth}])},[W("div",{class:Re(["navbar-header-box",{"bg-#fff dark:bg-#1e1e20":e.auth,"bg-#8d8b89 bg-opacity-30":!e.auth}])},[Sn(n.$slots,"default",{},void 0,!0),t[0]||(t[0]=W("div",{style:{flex:"1"}},null,-1)),e.auth?(ne(),ie($e,{key:0},[J(o),J(r),J(a)],64)):Nn("",!0),J(i)],2)],2)}}}),jt=ve(Bt,[["__scopeId","data-v-0b4ec54b"]]),Ot=T({name:"NavigationSideLogo",props:{auth:{type:Boolean,default:!0}},setup(){return{title:P(()=>"NaiveUI Template 项目")}}}),Tt="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20207.74%20252.58'%3e%3cdefs%3e%3cstyle%3e.cls-1{fill:%2393ceaa;}.cls-2{fill:%234c9717;}.cls-3{fill:%235fbc21;}.cls-4{fill:%23e8ceaa;opacity:0.6;}%3c/style%3e%3c/defs%3e%3ctitle%3eNaive%20UI%20-%20LOGO%3c/title%3e%3cg%20id='Layer_2'%20data-name='Layer%202'%3e%3cg%20id='Layer_1-2'%20data-name='Layer%201'%3e%3cpath%20class='cls-1'%20d='M60.37,205.2c0,2.5,0,5,.05,7.5,0,.54,0,1.07-.05,1.58Z'/%3e%3cpath%20class='cls-1'%20d='M147.29,37.68v85.2c-.06-27.24-.19-54.49-.22-81.73A29,29,0,0,1,147.29,37.68Z'/%3e%3cpath%20class='cls-2'%20d='M147.06,125.43a16.9,16.9,0,0,0,.23-2.55v79.66l-41.74-38.17-21-19.15L71.91,133.6l-5.62-5.13-2.07-1.89-.15-.13c-.51-.41-1-.84-1.47-1.23s-.88-.73-1.44-.56a1.25,1.25,0,0,0-.79.9v-75l.43.39,8.57,7.75c4.51,4,9.06,8,13.56,12Q92.53,79.3,102.07,88q7.55,6.86,15.08,13.74c6,5.47,11.92,11,17.92,16.43,2.7,2.44,5.42,4.83,8.15,7.23.58.51,1.15,1,1.74,1.52a1.47,1.47,0,0,0,1.4.18,1.16,1.16,0,0,0,.56-.72C147,126,147,125.74,147.06,125.43Z'/%3e%3cpath%20class='cls-3'%20d='M60.28,126a15.67,15.67,0,0,0-.1,2.74c0,25.5,0,51,.19,76.49v9.08a14.85,14.85,0,0,1-5.87,11.09c-6.81,5.69-13.16,11.91-19.73,17.89-2.75,2.5-5.48,5-8.31,7.44s-10.11,2.74-14.14-.63a78.48,78.48,0,0,1-8.54-8.66,12.76,12.76,0,0,1-3.73-8.69c0-.72-.06-1.51,0-2.38,0-1.5,0-3,.05-4.51.05-4.3,0-8.61,0-12.91V72.71a12.64,12.64,0,0,1,.38-3.18,18.42,18.42,0,0,1,1-2.64A22.16,22.16,0,0,1,3.5,63.31l16-16L29.69,37.13a7.84,7.84,0,0,1,1.84-1.38,8.05,8.05,0,0,1,3.21-1h0a13.85,13.85,0,0,1,9.71,1.79h0a13.59,13.59,0,0,1,2.09,1.57L60.37,50.53v75A3.38,3.38,0,0,0,60.28,126Z'/%3e%3cpath%20class='cls-4'%20d='M60.28,126a3.38,3.38,0,0,1,.09-.41V205.2c-.15-25.5-.14-51-.19-76.49A15.67,15.67,0,0,1,60.28,126Z'/%3e%3cpath%20class='cls-3'%20d='M205.59,187.21l-29.39,27a3.75,3.75,0,0,1-.36.24l-.11.08-.2.12A14,14,0,0,1,158.77,213L157,211.45l-9.75-8.91V37.68c.16-1.39.4-2.78.67-4.14.7-3.55,3.82-5.31,6.2-7.53,5.17-4.8,10.5-9.42,15.77-14.12,3.63-3.24,7.25-6.49,10.91-9.71,3.19-2.81,9.37-2.67,12.37-.93a10.11,10.11,0,0,1,2.08,1.61l3.38,3.26,2.73,2.61,2.49,2.41a11.45,11.45,0,0,1,1.78,2.09,11.73,11.73,0,0,1,1.7,6.46c-.05,14.66.06,29.32.09,44q.09,37.35.16,74.7,0,19.14.07,38.27c0,.59,0,1.17,0,1.75C207.8,182.21,207.72,184.72,205.59,187.21Z'/%3e%3c/g%3e%3c/g%3e%3c/svg%3e",zt={class:"side-logo-container"};function Ft(e,n,t,o,r,a){const i=Rn("router-link");return ne(),ie("div",zt,[J(i,{to:"/"},{default:Q(()=>[n[0]||(n[0]=W("img",{class:"side-logo-img",src:Tt,alt:"商标"},null,-1)),W("h1",{class:Re(["side-logo-title c-#303133 dark:c-#fff",{"c-#303133 dark:c-#fff":e.auth,"c-#fff dark:c-#303133":!e.auth}])},Ue(e.title),3)]),_:1,__:[0]})])}const Gt=ve(Ot,[["render",Ft],["__scopeId","data-v-8767ff33"]]);export{jt as N,Gt as a,Mt as u};
